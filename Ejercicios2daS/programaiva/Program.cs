// Descripción: Programa que calcula el IVA para una ferretería (ejercicio #2)
// ejemplos de format exception y overflow exception
...
class Ferreteria // Calculo de IVA
{
    ...
    {
        int cantidad = 0; // Variable para la cantidad de artículos__+++
        ...
        while (true)
        {
            ...
            string cantidadInput = Console.ReadLine() ?? ""; // Lee la entrada del usuario, nunca será null o 0 
            try
            {
