...
namespace BibliotecaEstructurada
{
    ...
    class Libro
    {
        ...
        public string Autor { get; set; } // get (leer) y set (modificar) permiten controlar cómo se accede y modifica un valor privado de una clase.
    }   // usamos eso porque esas propiedades permiten agregar reglas, como evitar valores negativos, registrar cambios, etc.
